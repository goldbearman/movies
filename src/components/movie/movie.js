...
export default class Movie extends PureComponent {
  ...
  onChangeStars = (stars) => {
    ...
    console.log(this.state.rateDefault);
  ...
  render() {
    ...
    console.log(this.state.rateDefault +" rate")
      ...
      <Col span={12}>
        <div className='card'>
          ...
          <div className="card__content">
            ...
            <Rate className="stars" count="10" defaultValue={this.state.rateDefault} onChange={this.onChangeStars} value={this.state.rateDefault}/>
          </div>
        </div>
      </Col>
    )
